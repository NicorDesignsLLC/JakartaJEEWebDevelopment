...
CREATE TABLE charitydb.USER_ADMIN_ROLES (
  USERNAME  VARCHAR(50) NOT NULL,
  AUTHORITY VARCHAR(50) NOT NULL,
  FOREIGN KEY (USERNAME) REFERENCES USER_ADMIN(USERNAME)
);

INSERT INTO charitydb.USER_ADMIN_ROLES (USERNAME, AUTHORITY) VALUES
  ('Nicolaas', 'ROLE_ADMIN'),
  ('Danette', 'ROLE_USER'),
  ('Tom', 'ROLE_USER');
