...
public class ChatEndpoint implements HttpSessionListener
{
    ...
    private static final String HTTP_SESSION_PROPERTY = "com.nicordesigns.site.ws.HTTP_SESSION";
    private static final String WS_SESSION_PROPERTY = "com.nicordesigns.site.http.WS_SESSION";
