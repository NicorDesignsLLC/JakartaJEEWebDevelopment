...
@Service
public class SpringWebSocketChatService implements ChatService {
	
	private static final Logger log = LogManager.getLogger();

    private final Map<Long, ChatSession> sessions = new HashMap<>();
    private final Map<Long, List<ChatMessage>> chatLogs = new HashMap<>();
