...
{
    private static final String HTTP_SESSION_PROPERTY = "com.nicordesigns.ws.HTTP_SESSION";
    private static final String WS_SESSION_PROPERTY = "com.nicordesigns.http.WS_SESSION";
