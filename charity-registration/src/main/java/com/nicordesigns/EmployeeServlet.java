...
@WebServlet(
        ...
        urlPatterns = {"/employee"}, loadOnStartup = 1
)
public class EmployeeServlet extends HttpServlet {
    ...
    private void searchEmployeeById(HttpServletRequest req, HttpServletResponse resp)
        ...
        String nextJSP = "/WEB-INF/jsp/view/new-employee.jsp";
    ...
    private void forwardListEmployees(HttpServletRequest req, HttpServletResponse resp, List employeeList)
            throws ServletException, IOException {
        String nextJSP = "/WEB-INF/jsp/view/list-employees.jsp";
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher(nextJSP);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeServlet other = (EmployeeServlet) obj;
		return Objects.equals(employeeService, other.employeeService);
	}
